...
if __name__ == '__main__' :
	...
	try :
		...
		with tf.Session() as sess:
			...
			softmax_tensor_red = sess.graph.get_tensor_by_name('final_result_red:0')
			softmax_tensor_blue= sess.graph.get_tensor_by_name('final_result_blue:0')
			...
			while True:
        		...
        		if ret_val:
					if(red_flag) :
            			predictions = sess.run(softmax_tensor_red, {'DecodeJpeg:0': img})
					else :
						predictions = sess.run(softmax_tensor_blue, {'DecodeJpeg:0': img})
